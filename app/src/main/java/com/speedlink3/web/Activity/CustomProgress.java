...
public class CustomProgress {
    ...
    public void showProgress(Context context, boolean cancelable) {
        ...
        if (RemoteConfigUtils.getLoaderStyle().equals("Wave")) {
            Wave wave = new Wave();
            if (isValidColor(RemoteConfigUtils.getLoaderColor())) {
                wave.setColor(Color.parseColor(RemoteConfigUtils.getLoaderColor()));
            }
            ...
            if (isValidColor(RemoteConfigUtils.getLoaderColor())) {
                rotatingPlane.setColor(Color.parseColor(RemoteConfigUtils.getLoaderColor()));
            }
            ...
            if (isValidColor(RemoteConfigUtils.getLoaderColor())) {
                doubleBounce.setColor(Color.parseColor(RemoteConfigUtils.getLoaderColor()));
            }
            ...
            if (isValidColor(RemoteConfigUtils.getLoaderColor())) {
                wanderingCubes.setColor(Color.parseColor(RemoteConfigUtils.getLoaderColor()));
            }
            ...
            if (isValidColor(RemoteConfigUtils.getLoaderColor())) {
                pulse.setColor(Color.parseColor(RemoteConfigUtils.getLoaderColor()));
            }
            ...
            if (isValidColor(RemoteConfigUtils.getLoaderColor())) {
                chasingDots.setColor(Color.parseColor(RemoteConfigUtils.getLoaderColor()));
            }
            ...
            if (isValidColor(RemoteConfigUtils.getLoaderColor())) {
                threeBounce.setColor(Color.parseColor(RemoteConfigUtils.getLoaderColor()));
            }
            ...
            if (isValidColor(RemoteConfigUtils.getLoaderColor())) {
                circle.setColor(Color.parseColor(RemoteConfigUtils.getLoaderColor()));
            }
            ...
            if (isValidColor(RemoteConfigUtils.getLoaderColor())) {
                cubeGrid.setColor(Color.parseColor(RemoteConfigUtils.getLoaderColor()));
            }
            ...
            if (isValidColor(RemoteConfigUtils.getLoaderColor())) {
                fadingCircle.setColor(Color.parseColor(RemoteConfigUtils.getLoaderColor()));
            }
            ...
            if (isValidColor(RemoteConfigUtils.getLoaderColor())) {
                foldingCube.setColor(Color.parseColor(RemoteConfigUtils.getLoaderColor()));
            }
            ...
            if (isValidColor(RemoteConfigUtils.getLoaderColor())) {
                rotatingCircle.setColor(Color.parseColor(RemoteConfigUtils.getLoaderColor()));
            }
